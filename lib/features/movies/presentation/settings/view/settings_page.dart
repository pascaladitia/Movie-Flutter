...
class SettingsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (_) => ProfileViewCubit(sl<ProfileLocalDataSource>())..load(),
      child: Scaffold(
                            ...
                            children: [
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: CircleAvatar(
                                      ...
                                      child: profile.imagePath == null ? const Icon(Icons.person, size: 36) : null,
                                    ),
                                  ),
                              ...
                              _ProfileInfoRow(
                                ...
                                value: profile.birthDate == null
                                    ? '-'
                                    : DateFormat('dd MMM yyyy').format(DateTime.parse(profile.birthDate!)),
                              ),
                              const SizedBox(height: 10),
                              _ProfileInfoRow(
